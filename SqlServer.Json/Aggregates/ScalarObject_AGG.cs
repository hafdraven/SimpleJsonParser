...
public struct ScalarObject_AGG:IBinarySerialize
{
    ...
    public void Accumulate(SqlString Key, SqlString Value, SqlByte MergeFlag)
    {
        ...
        _value.Add(new JsonString(Key.ToString()), JsonValue.ParseScalar(Value.ToString()), _mergeOption);
    }

    public void Merge (ScalarObject_AGG Group)
    {
